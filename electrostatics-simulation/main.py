...
def drawGameWindow():
    ...
    pygame.draw.line(
        win, (0, 0, 0), (0, windowInfo.ceiling), (windowInfo.width, windowInfo.ceiling)
    )
...
def drawGrid():
    ...
    # y-axis
    pygame.draw.line(
        win, (0, 0, 155), (orginX, windowInfo.height), (orginX, windowInfo.ceiling)
    )
    ...
    pygame.draw.line(
        win,
        (0, 0, 155),
        (0, round(windowInfo.height - windowInfo.ceiling) / 2),
        (windowInfo.width, round(windowInfo.height - windowInfo.ceiling) / 2),
    )
...
instructions = font.render(
    "Click anywhere to place charge. Click on charge to set as target charge",
    1,
    (0, 0, 0),
)
# main loop
